    ...
    <section>
      <div className='section-header'>
        ...
        <p className='text-lg font-light leading-relaxed mt-4 mb-4 text-slate-600'>
          I use <span className='font-medium'>GitHub</span> as a code
          hosting platform for version control and collaboration and{' '}
          <span className='font-medium'>Netlify</span> to deploy the
          websites. <br /> Here are some of my social network
          accounts:
        </p>
        <div className='flex flex-row gap-4 justify-start'>
          {/* Github */}
          <div>
            <a href='https://github.com/shalunts' target='_blank'>
              <svg
                fill='gray'
          ...
          <div>
            <a
              href='https://www.linkedin.com/in/shalunts/'
              target='_blank'
            >
              <svg
                fill='gray'
          ...
          {/* CodePen  */}
          <div>
            <a href='https://codepen.io/shalunts/' target='_blank'>
              <svg
                fill='gray'
                xmlns='http://www.w3.org/2000/svg'
                width='24'
          ...
          <div>
            <a
              href='https://instagram.com/haykshalunts/'
              target='_blank'
            >
              <svg
                fill='gray'
